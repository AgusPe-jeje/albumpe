...
async function inspeccionarPerfilRival(usuarioId) {
     ...
     try {
          ...
          // 3. ⚽ Bloque B: Rendimiento en Competencia del Rival (Sincronizado con Penales de Neon)
          const txtPenalesEfectividad = document.getElementById("rival-txt-timba-efectividad") || document.getElementById("rival-txt-penales-efectividad");
          const txtPenalesJugadas = document.getElementById("rival-txt-timba-jugadas") || document.getElementById("rival-txt-penales-jugadas");
